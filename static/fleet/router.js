...
export const ROUTES = [
  ...
  { name: 'driver-new',      re: /^\/fleet\/drivers\/new$/ },
  { name: 'driver-edit',     re: /^\/fleet\/drivers\/([^/]+)\/edit$/, id: true },
  ...
  { name: 'facility-new',    re: /^\/fleet\/facilities\/new$/ },
  { name: 'facility-edit',   re: /^\/fleet\/facilities\/([^/]+)\/edit$/, id: true },
  { name: 'facility-detail', re: /^\/fleet\/facilities\/([^/]+)$/, id: true },
